...
class AddCandidates extends Component {
  ...
  handleOnFileLoad = (data, file) => {
    ...
    if (file.name.includes('.csv')) {
      ...
      console.log('THE FILE YOU UPLOADED IS NOT CSV');
    }
  }
  ...
  confirmSubmit() {
    swal.fire({
      title: language.caution[this.context.language],
      text: language.addCandidatesCaution[this.context.language],
      icon: 'warning',
      ...
      if (result.isConfirmed) {
        this.handeSubmit();
        swal.fire({
          text: language.addCandidatess[this.context.language],
          icon: 'success',
        })
      }
    })
